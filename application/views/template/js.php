...
<script src="<?php echo base_url('assets/template') ?>/plugins/dropzone/min/dropzone.min.js"></script>

<script src="<?php echo base_url('assets/template') ?>/plugins/codemirror/codemirror.js"></script>
<script src="<?php echo base_url('assets/template') ?>/plugins/codemirror/mode/css/css.js"></script>
<script src="<?php echo base_url('assets/template') ?>/plugins/codemirror/mode/xml/xml.js"></script>
<script src="<?php echo base_url('assets/template') ?>/plugins/codemirror/mode/htmlmixed/htmlmixed.js"></script>
